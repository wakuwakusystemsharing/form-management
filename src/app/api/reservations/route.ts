              ...
              try {
                await sendReservationEmails({
                  reservation: {
                    ...
                    customer_info: newReservation.customer_info || null,
                    message: body.message || null,
                    staff_name: (newReservation as any).staff_name || null,
                    staff_no_preference: body.staff_no_preference === true,
            ...
            try {
              await sendReservationEmails({
                reservation: {
                  ...
                  customer_info: reservation.customer_info || customerInfo || null,
                  message: body.message || null,
                  staff_name: reservation.staff_name || staffFields.staff_name || null,
                  staff_no_preference: staffFields.staff_no_preference === true,
                  booking_mode: body.booking_mode || null,
                },
                store: storeInfo as any,
                form: { config: formConfig },
